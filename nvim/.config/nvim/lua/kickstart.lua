...
require("lazy").setup({
	...
	{ -- Adds git related signs to the gutter, as well as utilities for managing changes
		...
		config = function(_, opts)
			...
			vim.keymap.set(
				...
				{ silent = true, desc = "[H]unk [P]review" }
			)
	...
	{ "Bilal2453/luvit-meta", lazy = true },
	{
		...
		config = function()
			...
			if vim.g.have_nerd_font then
				...
				vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#1e222a", fg = "#c8d0e0" })
				vim.api.nvim_set_hl(0, "FloatBorder", { bg = "#1e222a", fg = "#c8d0e0" })
			...
			-- This fixes an issue with the language server where it would not start
	...
	{ -- Autoformat
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				local disable_filetypes = { c = true, cpp = true, python = true, r = true }
	...
	{ -- Autocompletion
		...
		config = function()
			...
			cmp.setup({
				...
				-- },
				formatting = {
					format = function(entry, vim_item) -- to remove duplicate suggestions
						vim_item.menu = ({
							nvim_lsp = "[LSP]",
							vsnip = "[Snippet]",
							nvim_lua = "[Nvim Lua]",
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- - sr)'  - [S]urround [R]eplace [)] ['] require('mini.surround').setup()
	...
	--   config = function()
	--     vim.g.semshi_auto_update = 1 -- Enable automatic updates
	--     vim.g.semshi_highlight_references = 1 -- Highlight variable references
	--   end,
	-- },
	...
	require("pluggins.image"),
	require("pluggins.molten"),
