...
\definecolor{bluetheorembg}{HTML}{E8E9F5}
\definecolor{bluetheoremborder}{HTML}{2E327D}
...
\tcbset{
  plainblue/.style={
    enhanced,
    colback=bluetheorembg,
    colframe=bluttheoremborder,
    coltitle=black,
    fonttitle=\bfseries,
    boxrule=0.6pt,
    arc=6pt,
...
\newtcbtheorem[number within=section]{note}{Note}{plainblue}{note}
...
\newcommand\infosign[1][1.5ex]{%
  \renewcommand\stacktype{L}%
  \scaleto{%
    \stackon[1pt]{\textcolor{blue!70!black}{\large$\circ$}}%
      {\raisebox{0.1ex}{\tiny\bfseries\textcolor{blue!70!black}{i}}}%
  }{#1}%
}

% Discreet info: symbol + optional explanatory text in margin
\newcommand{\info}[1]{%
  \marginnote{\infosign[2.8ex]\ \textcolor{blue}{\textsf{\small #1}}}%
}
