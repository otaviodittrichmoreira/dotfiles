...
\definecolor{codebg}{RGB}{245,245,245}       % background color
\definecolor{keywordcolor}{RGB}{30, 102, 245} % keywords
\definecolor{commentcolor}{RGB}{76, 79, 105} % comments
\definecolor{stringcolor}{RGB}{64, 160, 43}  % strings
\definecolor{numbercolor}{RGB}{220,50,47}   % numbers
...
\definecolor{lightgray}{gray}{0.95} % Defines a light gray color
...
\lstnewenvironment{Rcode}[1][] % optional args
{\lstset{style=Rstyle,#1}} % apply style + optional args
{}

\newcommand{\Rexternal}[2][]{%
  \lstinputlisting[style=Rstyle,#1]{#2}%
}

\newcommand{\codeoutput}[2][]{%
  \lstinputlisting[keywordstyle=\color{black}, #1]{#2.log}%
}
